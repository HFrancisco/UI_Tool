...
public class PanelDropTarget implements DropTargetListener {
  ...
  public static void main(String[] args) {
	 ...
	 /* try {
	  ...
	  pane.setLayout(null);
	  PanelDropTarget panel = new PanelDropTarget(pane);*/
    ...
    JButton btnComponents = new JButton("New button");
	btnComponents.setBounds(35, 104, 89, 23);
	TransferHandler transferBtn = new TransferHandler("text");
	btnComponents.setTransferHandler(transferBtn);
	btnComponents.addMouseListener(new MouseAdapter(){
